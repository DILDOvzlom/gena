(function(factory) {
    ...
    Jarallax.prototype.init = function() {
        ...
        // переворот и перепедвертам фоток 
        _this.getImageSize(_this.image.src, function(width, height) {
            ...
            // чсрочка отвечает за фон
            _this.$item.data('jarallax-original-styles', _this.$item.attr('style'));

            // время возврашение назад тарифов, картинок
            setTimeout(function() {
                _this.$item.css({
    ...
    // уменшение размеров фото до нужного 100 на 100
